...
const skillCategories = [
  {
    ...
    skills: [
      { name: "Python (Primary)", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" },
        ...
        <div className="space-y-10">
          {skillCategories.map((category) => (
            <SectionWrapper key={category.title}>
              <div>
                <h3 className="text-lg md:text-xl font-bold font-heading text-primary/80 mb-4 border-l-2 border-primary/50 pl-3">
                  {category.title}
                </h3>
